...
4. Preserve the exact wording from the image`;
    ...
    // Update the upload step rendering
    if (step === 'upload') {
        return (
            <div>
                ...
                <div className="mb-4">
                    ...
                    <div className="flex gap-4">
                        <label className="inline-flex items-center">
                            ...
                            />
                            <span className="ml-2">JSON (Recommended)</span>
                        </label>
                        <label className="inline-flex items-center">
                            <input
                                type="radio"
                ...
                <div className="mb-6">
                    <ImageUploader
                        ...
                        onProcessed={processImageWithClaude}
                ...
                <div className="flex items-center mb-6">
                    ...
                    <span className="flex-shrink mx-4 text-gray-500">or paste text directly</span>
                    <div className="flex-grow border-t border-gray-300"></div>
                </div>
