        ...
        const fetchScores = async () => {
            try {
                ...
                if (response.data && response.data.success) {
                    ...
                    throw new Error(response.data?.message || 'Failed to fetch PRITE scores');
                }
            } catch (error) {
    ...
    const handleDelete = async (scoreId) => {
        try {
            ...
            if (response.data && response.data.success) {
                ...
                throw new Error(response.data?.message || 'Failed to delete score record');
            }
        } catch (error) {
            console.error('Error deleting score record:', error);
            setError(error.message || 'Failed to delete score record');
        } finally {
            setLoading(false);
        }
    };
